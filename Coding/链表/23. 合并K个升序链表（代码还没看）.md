...
public:
    ...
    ListNode* mergeKLists(vector<ListNode*>& lists) {
        ...
        ListNode head,*tail = &head;// 哨兵节点、哨兵指针
...
public:
    ...
    ListNode* next;
    Node1(){}
    Node1(int _val,ListNode* _next):val(_val),next(_next){}
    Node1(int _val):val(_val),next(nullptr){}
    ...
    ListNode* mergeKLists(vector<ListNode*>& lists) {
        ...
        while(!q.empty()){
            ...
            if(p.next->next!=nullptr)
                q.push(Node1(p.next->next->val,p.next->next));
        }
        return tmp->next;
    }
};
